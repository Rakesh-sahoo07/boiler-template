...
import { Navbar, NavLogo, NavItem, Footer, FooterContent, FooterSection, FooterLink, FooterDivider, FooterBottom, FooterSocial, FooterSocialLink } from './components/layout'
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold text-lg">Your Project</span>
              </div>
              <p className="text-sm text-muted-foreground mb-4">
                Building the future with modern web technologies and Web3 integration.
              </p>
              <FooterSocial>
